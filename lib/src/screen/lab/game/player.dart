...
class Player extends SpriteComponent with HasGameRef<FlappyDash>, CollisionCallbacks {
  ...
  void update(double dt) {
    ...
    if (direction == null) {
      ...
      if (position.x >= gameRef.size.x - size.x) return;
      velocityVector = Vector2(100, 0);
  ...
  Future<void> onLoad() async {
    super.onLoad();
    add(CircleHitbox());
    sprite = await gameRef.loadSprite('game/dash_plane.png');
  }
}
